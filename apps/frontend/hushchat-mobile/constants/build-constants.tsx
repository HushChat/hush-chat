export const BuildConstantKeys = {
  ...
  APP_STORE_ID: "EXPO_PUBLIC_APP_STORE_ID",
  PLAY_STORE_PACKAGE_NAME: "EXPO_PUBLIC_PLAY_STORE_PACKAGE_NAME",
  HEALTH_CHECK_API_KEY: "EXPO_PUBLIC_HEALTH_CHECK_API_KEY",
} as const;
...
const BuildConstant: Record<BuildConstantValueKey, string | undefined> = {
  ...
  EXPO_PUBLIC_PLAY_STORE_PACKAGE_NAME: process.env.EXPO_PUBLIC_PLAY_STORE_PACKAGE_NAME,
  EXPO_PUBLIC_HEALTH_CHECK_API_KEY: process.env.EXPO_PUBLIC_HEALTH_CHECK_API_KEY,
};
