...
export const MESSAGE_UNSENT_TOPIC = "/topic/message-unsent/";
export const MESSAGE_REACTION_TOPIC = "/topic/message-reaction/";

export const INVALID_ACCESS_TOKEN_ERROR = "Invalid access token format or structure";

export const RETRY_TIME_MS = 10000;
export const ERROR_RESPONSE = "ERROR";
export const MESSAGE_RESPONSE = "MESSAGE";
export const CONNECTED_RESPONSE = "CONNECTED";
