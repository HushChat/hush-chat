export const AUTH_API_ENDPOINTS = {
  ...
  LOGOUT: (accessToken: string) =>
    `/public/user/sign-out?accessToken=${accessToken}`,
...
export const CONVERSATION_API_ENDPOINTS = {
  ...
  GET_BY_ID: (conversationId: number) =>
    `${CONVERSATION_API_BASE}/${conversationId}/meta`,
  ...
  ARCHIVE: (conversationId: number) =>
    `${CONVERSATION_API_BASE}/${conversationId}/archive`,
  FAVOURITE: (conversationId: string) =>
    `${CONVERSATION_API_BASE}/${conversationId}/favorite`,
  ...
  PIN_CONVERSATION: (conversationId: number) =>
    `${CONVERSATION_API_BASE}/${conversationId}/pin`,
  ...
  EXIT_GROUP: (conversationId: number) =>
    `${CONVERSATION_API_BASE}/${conversationId}/leave`,
  REPORT_GROUP: (conversationId: number) =>
    `${CONVERSATION_API_BASE}/${conversationId}/report`,
  ...
  UPDATE_CONVERSATION: (conversationId: number) =>
    `${CONVERSATION_API_BASE}/${conversationId}`,
...
export const USER_API_ENDPOINTS = {
  ...
  BLOCK_USER: (blockedUserId: number) =>
    `${USER_API_BASE}/${blockedUserId}/block`,
  UNBLOCK_USER: (blockedUserId: number) =>
    `${USER_API_BASE}/${blockedUserId}/unblock`,
  CALL_LOGS: `${USER_API_BASE}/call-logs`,
  PROFILE_IMAGE_SIGNED_URL: (userId: string) =>
    `/users/${userId}/profile/upload-photo`,
  SAVE_TOKEN: `/notifications/device-token`,
};

export const MESSAGE_API_ENDPOINTS = {
  REACTIONS: (messageId: number) =>
    `${MESSAGE_API_BASE}/${messageId}/reactions`,
