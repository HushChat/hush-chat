...
export default function ChatInterface({
  ...
  return (
    <ScrollView
      className="custom-scrollbar min-h-full"
    >
      <ScrollView
        ...
        <View className="flex-1 bg-background-light dark:bg-background-dark">
          <View className="flex-row relative h-full">
            <View
              ...
              className="w-[470px] min-w-72 max-w-2xl lg:w-[460px] bg-background-light dark:bg-background-dark border-r border-secondary-light dark:border-secondary-dark"
            >
              <ConversationHeader
