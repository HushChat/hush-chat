...
export const useAudioRecording = ({
  ...
  const audioUploader = useMessageAudioUploader(conversationId);
  ...
  const handleStopRecording = useCallback(async () => {
    ...
    try {
      ...
      if (recordingInstance.platform === "web") {
        ...
        uploadResults = await audioUploader.uploadAudioFileFromWeb(audioFile);
      } else {
        ...
        uploadResults = await audioUploader.uploadAudioLocalFileMobile(localFile);
      }
  ...
  }, [recordingInstance, audioUploader, conversationId, storage, clearTimer]);
